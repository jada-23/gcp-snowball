...
public class Application {
    ...
    static class WriteCommittedStream {
        ...
        public WriteCommittedStream(String projectId, String datasetName, String tableName)
            ...
            try (BigQueryWriteClient client = BigQueryWriteClient.create()) {
                ...
                jsonStreamWriter = JsonStreamWriter.newBuilder(writeStream.getName(), writeStream.getTableSchema())
                        .build();
            }
        }
